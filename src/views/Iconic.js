      ...
      <div style={{ width: "100%", display: "block", position: "relative" }}>
        ...
        >
          ...
          >
            <p>
              ...
              Internet Computer blockchain (or “IC” for short). The exhibit
              features artists from all over the world, including New York, Los
              Angeles, Miami, Singapore, Japan, Istanbul, and Paris.
            </p>

            <p>
              Much of the depiction around our relationship with technology in
              the media is overwhelmingly negative. Films and shows such as
              Blade Runner, The Matrix, Minority Report, Ghost in the Shell, and
              so on present a bleak dystopia, where technology is wielded in a
              way to control and surveil the populace.
            </p>

            <p>
              In contrast, ICONIC seeks to reframe our relationship with
              technology and imagine how technology can be used to bridge and
              connect humanity, as well as empower the individual, through
              decentralized technologies such as the Internet Computer. The
              artwork featured in the exhibit brims with scintillating
              techno-optimism for the future, with pieces that are unabashedly
              bold, dynamic, energetic, and full of life. In this brave new
              world, it is the artists and creators who wield the power, for art
              is the most distilled expression of the human condition.
            </p>

            <p>
              To this end, NFTs have become a powerful new vehicle for artists
              to share their creative vision. The most innovative artists have
              always used new technology and media as a means to amplify their
              core message.
            </p>

            <p>
              <strong>
                Enjoy ICONIC, and let’s dream of a brighter, more colorful
                future, one where technology ignites in us once again a sense of
                wonder and hope.
              </strong>
            </p>
          </div>
        ...
        <div className={classes.footer}>
          <Typography variant="body1">
            Developed by refound media &copy; All rights reserved 2021
          </Typography>
        </div>
      </div>
    </>
